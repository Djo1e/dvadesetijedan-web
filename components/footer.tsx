...
export function Footer() {
  return (
    <footer className="flex flex-col justify-between px-16 pb-16 md:flex-row pt-11 bg-dark brightness-110">
      <div className="flex items-center">
        <span className="hidden lg:block">
          <BarcodeFooterIcon />
        </span>

        <ul className="flex justify-between w-full ml-0 lg:justify-start lg:w-auto lg:ml-8 text-gray">
