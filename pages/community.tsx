  ...
  return (
    <main className="bg-dark">
      <div className="flex flex-col items-center justify-center py-20 text-center bg-dark brightness-110">
        <h1 className="text-4xl">DvadesetJedan Blog</h1>
        <p className="mt-4 mt-6 text-lg text-gray">
          Original resources and translations of popular content from the Bitcoin community.
        </p>
        <p className="text-sm text-gray">Get notified when we translate a new resource:</p>
        <div className="mt-6">
      ...
      <div className="px-20 py-20 lg:px-32 xl:px-40 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-7 gap-y-16">
